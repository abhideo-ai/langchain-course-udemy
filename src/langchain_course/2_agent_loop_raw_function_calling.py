...
tools_for_llm = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "product_name": {
                        "type": "string",
                        "description": "The product name, e.g., 'laptop', 'headphones', 'tablet', 'keyboard'",
                    },
                },
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply a disacount tier to a price and return the final price. Available tiers: bronze, silver, gold, platinum",
            "parameters": {
                "type": "object",
                "properties": {
                    "price": {
                        "type": "number",
                        "description": "The price of the product received from the call to get_product_price tool call.",
                    },
                    "discount_tier": {
                        "type": "string",
                        "description": "The discount tier. e.g., bronze, silver, gold, platinum",
                    },
                },
...
def run_agent(question: str):
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "3. NEVER calculate disacounts yourself using math."
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        observation = tool_to_call_fn(**tool_args)
